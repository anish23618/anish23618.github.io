...
* **Data Scientist**, Haber Water *(Team Lead since Sep 2022)* `[January 2022 - May 2024]`
  ...
  - **Robust Time-Series Modeling:** Engineered a high-noise training methodology that improved model accuracy by 3% and doubled model longevity; successfully standardized this approach across five major projects.
...
Frameworks:    PyTorch, LangGraph, Graph Neural Networks (PyG), Agentic LLM Orchestration (Boto3 / Vertex AI)
