...
**Staff Data Scientist** | **Mathematical Physicist**1
...
[![Google Scholar](https://img.shields.io/badge/Google_Scholar-Citations-4285F4?style=flat&logo=google-scholar&logoColor=white)](http://scholar.google.co.in/citations?user=gVn3rxMAAAAJ&hl=en)
[![ORCID](https://img.shields.io/badge/ORCID-0000--0001--9534--791X-A6CE39?style=flat&logo=orcid&logoColor=white)](http://orcid.org/0000-0001-9534-791X)
...
* Data Scientist, Haber Waters (Team lead since Sep 2022) [January 2022-May 2024]
  ...
  - **AWS-Based Resource Optimization** Designed a suite of AWS EC2-hosted applications for paper mill stock cutting, consistently reducing trim loss to under 1% in 90% of cases.
  - **Edge-Adaptive Process Control** Led the development of continuous-learning models for edge devices, achieving a 20% performance boost over static models and eliminating frequent retraining across diverse process control systems.
  - **Robust Time-Series Modeling** Engineered a high-noise training methodology that improved model accuracy by 3% and doubled model longevity; successfully standardized this approach across
five major projects.
...
An interactive implementation of cellular automata investigating neighborhood-based boundary topology rules and stable chaotic configurations.

### 🌀 Chaos & Dynamical Operators *(Coming Soon)*
...
* **Quantified Horn Formula Satisfiability** *Developed a polynomial-time algorithm to verify the satisfiability of quantified Horn formulas ($\text{QBF}$ restriction), establishing deterministic structural bounds for predictive automated logic engines.*

### 🔹 Spectral Theory of Random Operators
* **The Anderson Model on Graphs & Trees** *Investigated spectral types, localization, and localized state boundary metrics for random Hamiltonians operating over varied infinite graph configurations and tree-like topologies.*
...
### 💻 Core Toolkit
```text
Languages:     Python, C, Java, UNIX Shell
Frameworks:    PyTorch, langgraph, Graph Neural Networks (PyG), Agentic LLM Orchestration (boto3/vertexai frameworks)
Compute:       AWS (EC2), GCP (VertexAI), MPI, OpenMP, OpenCL, Ortools
Typesetting:   LaTeX, Word Press
